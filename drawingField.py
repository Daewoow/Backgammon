...
class DrawingField:
    def __init__(self, field, x_coord, y_coord):
        self.field = field
        self.white_sprite = pygame.image.load("./images/Checker-white.png")
        self.black_sprite = pygame.image.load("./images/Checker-neger.png")
        self.dice_sprites = [self.white_sprite] * 7
        for i in range(1, 7):
            sprite = pygame.image.load(f"./images/{i}.png")
